<x-app-layout>
    <x-slot name="header">
        <h2 class=" font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Add User</h2>
    </x-slot>
    <div class="my-10">
        <div class="m-auto rounded-md  p-7 w-2/6 bg-gray-300 dark:bg-gray-800 ">
            <form method="POST" action="{{route('store.user')}}">
                ...
                <div class="flex items-center justify-end mt-4">
                    <button type="submit" class="bg-green-700 text-white px-2 py-3 rounded">Add User</button>
